...
export default function Eventos() {
  return (
    <div className="p-8 sm:p-6 md:p-16 lg:p-28 w-full  flex flex-col gap-8 ">
    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-orange-400">
  ...
  <div className="flex flex-row justify-end">
    ...
    <div className="flex flex-col sm:flex-col md:flex-row gap-6 justify-center">
      <Cads
        img={E1}
